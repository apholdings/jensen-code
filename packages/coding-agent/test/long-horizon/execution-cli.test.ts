/**
 * Mission Execution State Machine CLI tests.
 *
 * Tests all four execution routes: init, inspect, validate, transition.
 * Verifies atomic outputs, exit semantics, and trusted boundary rejection.
 */
